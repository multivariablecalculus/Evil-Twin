...
It requires an ESP8266 NodeMCU module, or an ESP32 NodemCU module. I personally used ESP8266 module for all the programs so, if you use my code you also need an ESP8266 module.
